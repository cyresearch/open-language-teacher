...
3. **She is proactive.** A nightly timer has her open the conversation and ask about your
   day, gently and without nagging. Speaking practice happens because someone starts it.
...
Wired today: Japanese, English, Chinese, and Korean, each with a local open-source voice.
...
## She becomes the teacher of whatever language I speak. What about my native language?
...
Not yet verified: alpha covers macOS (Apple Silicon) only. The pieces are mostly portable:
...
Any time. `config/teacher.md` is the single source of truth: edit and save, and she reads it
