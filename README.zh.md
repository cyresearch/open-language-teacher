...
我想让语言学习变成一件好玩的事。她不只是老师，也是能无话不谈的朋友：从今天吃了什么，到深夜里在想什么，她都接得住。她记得你说过的事，你会慢慢变得想主动找她说话。而开口，就是练习。
...
- 深聊时她会放下课本。你想聊研究、烦恼、想法的时候，她切换成朋友模式：跟你一起想，说自己的看法，不在你说心事的时候纠语法
- 她记得你。重要的事她会写进自己的思い出帳，改天自然地问起，那个发表后来怎么样了
- 每晚定时夜谈。到点她主动来问你今天做了什么，不布置作业，也不打卡。今晚没回，她明天照常来
- 每天早上有新闻推送。她联网现查当天新闻，挑你感兴趣的领域讲一两条，用简单的目标语言，配母语大意和生词。领域写在配置里，时间随你定
- 周日晚是复盘夜。她读完这一周的课堂笔记再来：高频错误配上正确说法、新掌握的词和语法、值得夸的进步瞬间，加一个下周小目标
...
在 16GB 内存的 Mac mini（M4）上实测。

存储，四语全装约 11GB，加声音克隆约 15GB：
...
| 中文嗓子 MeloTTS | 3.3GB |
| 韩语嗓子 MeloTTS | 2.6GB |
| 声音克隆 GPT-SoVITS（可选） | 3.5GB |

内存。老师 24 小时在线，但常驻的很少：

- 常驻只有值班程序（很小）、日语引擎 VOICEVOX（约 0.8GB）、中韩 MeloTTS（各约 1.3GB，不学就不装）
- 听写和英语合成用时加载、用完就退，说话时峰值再加约 1.5GB
- 声音克隆服务用时才启动（约 3GB），闲置十分钟自动退出
- 只学日语常驻约 1GB；四语全开常驻约 3.5GB。16GB 的机器都够用

在线兜底：

- 每种语言都配了微软在线语音（edge-tts）兜底，本地引擎失败或没装时自动顶上，老师不哑火
- 兜底需要联网，音色和本地声优不同，且那一句的文本会发给微软的服务。介意就不装 edge-tts，兜底自动失效，其余照常
...
- 回复不算快。一轮通常十几秒到半分钟，像笔友，不像实时通话
- 日语的汉字读音偶尔会念错。多音字（比如「行った」读いった还是おこなった）靠语音引擎猜，猜错了就照错的念
- 你的语音先经过听写才到她眼前，这一步会失真：你读对的词可能被转成错字，你说错的地方也可能被悄悄转正，尤其是语法。结果是她可能高估你的水平，或者发现不了你读错了音
- 好消息是，就算转写有错，她基本都能明白你想表达的意思（亲测理解力很强）。这也说明一件事：老师的能力和风格，相当程度取决于你给她选的大脑。我用的是 Claude 的 opus 模型

## 听见更流利的自己

她纠正你的句子之后，用**你自己的声音**把地道的说法读给你听。那个「说得流利的自己」是最强的学习动力之一（Ideal L2 Self；Dörnyei, 2009）。CHI 2026 的 AI Twin 研究先做出了这件事，这里是本地开源版。

- 素材就是你平时发她的 Discord 语音，聊几天就攒够。项目自动切片转写，你在审核页删掉转写错的
